...
app.get('/stream', (req, res) => {
  ...
  if(currentFrame) send(currentFrame);
...
function sendModeCommand(customMode){
  ...
  payload.writeUInt16LE(176, 28);
  payload[30] = CONFIG.targetSys;
  payload[31] = CONFIG.targetComp;
  payload[32] = 0;
  const hdr = Buffer.alloc(10);
